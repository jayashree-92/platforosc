...
IF NOT EXISTS(SELECT * FROM INFORMATION_SCHEMA.COLUMNS WHERE TABLE_NAME= 'onBoardingAccount_bkup_Aug_24_2023' AND TABLE_SCHEMA ='dbo')
BEGIN
	SELECT * INTO DBMOD_Data_Backup_DB..onBoardingAccount_bkup_Aug_24_2023 FROM HM_WIRES.DBO.onBoardingAccount;
...
END
IF NOT EXISTS(SELECT * FROM INFORMATION_SCHEMA.COLUMNS WHERE TABLE_NAME= 'hmsWires_bkup_Aug_24_2023' AND TABLE_SCHEMA ='dbo')
BEGIN
	SELECT * INTO DBMOD_Data_Backup_DB..hmsWires_bkup_Aug_24_2023 FROM HM_WIRES.DBO.hmsWires;
