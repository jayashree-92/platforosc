...
IF EXISTS(SELECT 8 FROM INFORMATION_SCHEMA.COLUMNS WHERE COLUMN_NAME = 'dmaFundOnBoardId' AND TABLE_NAME = 'onBoardingAccount') BEGIN ALTER TABLE onBoardingAccount ALTER COLUMN dmaFundOnBoardId LONG NULL; END
