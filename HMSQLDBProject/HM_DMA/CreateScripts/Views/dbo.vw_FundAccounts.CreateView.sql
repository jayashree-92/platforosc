...
BEGIN
			...
			CASE WHEN LEN(acc.FFCNumber) >0 THEN acc.FFCNumber ELSE acc.UltimateBeneficiaryAccountNumber  END AS AccountNumber,
				...
				acc.[Description],acc.TickerorISIN,acc.CashSweep,acc.CashSweepTime,acc.CashSweepTimeZone,hcompany.Company AS ClientName,obClient.dmaClientOnBoardId,obfund.LaunchStatus,acc.HoldbackAmount
